...
//	email  : pinotoy@yahoo.com
	...
	var language = 'pl';	// Default Language: en - english ; es - spanish; de - german
	...
	var imgDir = '../style/common/img/';		// directory for images ... e.g. var imgDir="/img/"
	var dayName = '';

	var gotoString = {
		en : 'Go To Current Month',
		pl : 'Przejdz do aktualnego miesiaca'
	};
	var todayString = {
		en : 'Today is',
		pl : 'Dzis jest'
	...
	var scrollLeftMessage = {
		...
		pl : 'Kliknij, aby przejsc do poprzedniego miesiaca. Przytrzymaj klawisz myszy, aby przewijac automatycznie.'
	};
	var scrollRightMessage = {
		en : 'Click to scroll to next month. Hold mouse button to scroll automatically.',
		pl : 'Kliknij, aby przejsc do nastepnego miesiaca. Przytrzymaj klawisz myszy, aby przewijac automatycznie.'
	};
	var selectMonthMessage = {
		en : 'Click to select a month.',
		pl : 'Kliknij aby wybrac miesiac.'
	};
	var selectYearMessage = {
		en : 'Click to select a year.',
		pl : 'Kliknij aby wybrac rok.'
	};
	var selectDateMessage = {		// do not replace [date], it will be replaced by date.
		en : 'Select [date] as date.',
		pl : 'Wybierz [date] jako date.'
	};
	var	monthName = {
		en : new Array('January','February','March','April','May','June','July','August','September','October','November','December'),
		pl : new Array('Styczen','Luty','Marzec','Kwiecien','Maj','Czerwiec','Lipiec','Sierpien','Wrzesien','Pazdziernik','Listopad','Grudzien')
	};
	var	monthName2 = {
		en : new Array('JAN','FEB','MAR','APR','MAY','JUN','JUL','AUG','SEP','OCT','NOV','DEC'),
		pl : new Array('STY','LUT','MAR','KWI','MAJ','CZE','LIP','SIE','WRZ','PAZ','LIS','GRU')
	};

	if (startAt==0) {
		dayName = {
			en : new Array('Sun','Mon','Tue','Wed','Thu','Fri','Sat'),
			pl : new Array('Nie','Pon','Wto','Sro','Czw','Pia','Sob')
		};
	} else {
		dayName = {
			en : new Array('Mon','Tue','Wed','Thu','Fri','Sat','Sun'),
			pl : new Array('Pon','Wto','Sro','Czw','Pia','Sob','Nie')
		};
	}
